...
quick flow -- over land, pipes, etc.
baseflow -- groundwater, soil pathways
last class -- two streams were headwater streams -- from watershed 
for assignment -- streams will be bigger and further down network 
today -- hydrological & biological changes in water chemistry?
ex. salt concentration will decrease after quickflow but increase when reaches baseflow
...
#C-Q plots <-- concentration against flow ... how much does concentration change with flow? 
#log transform helps to disperse data to visualize more effectively 
```
...
Hysteresis occurs when the concentration varies with discharge in a different relationship on the rising and falling limbs of a storm. This can be caused by _flushing_ (positive relationship) behavior or _dilution_ (negative relationship) behavior.

_Chemostatic_ means neutral relationship... flat line

Sources of water at different times are coming from different pathways during a storm 
...
#As flow increases, concentration decreases
#On a C-Q plot, important to look at the slope 
```
...
#There is a cycling that occurs ... flow goes up and then down ... concentration is different throughout 
#counterclockwise means rising limb of storm has lower concentration than falling limb of storm 
#Clockwise means falling limb of storm has higher concentration than falling limb of storm 
#Different parts of storm are dominated by either quick flow or base flow 

#The Potomac Storm is diluting storm and counterclockwise 
#Concentrations of nitrate are lower in quickflow than in baseflow 
#Baseflow comes from groundwater
#Quickflow comes from overland flow
#More nitrate in the groundwater than on the surface of land 

#In general, diluting are more likely counterclockwise and less concentration in quickflow 

#In a flushing storm, will "flush" compound / solute and pushes large amount of solutes out and increases concentrations in river 
```
...
#model to use oxygen data to create metabolism
```
...
#big swings in oxygen concentration over the course of a day 
```
...
r is respiration
d is diffusion
oxygen concentrations differ with temeprature and depend on flow 
productivity increases oxygen concentrations (photosynthesis)
produtvitiy only occurs during the day ... respiration occurs all the time <-- oscillation in data & [DO]

Visit https://data.streampulse.org/ 
#Looked at 2017 Eno data -- ER is higher than GPP, so Eno River is net heterotrophic... consuming more carbon than producing 
