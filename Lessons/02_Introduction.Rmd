##NOTES-BEGINNING
To pull Git repository at the beginning of each class -- "git pull upstream master" in terminal 
##NOTES-END
---
...
=======================================
- accessible color palettes --> and attractive & logical ones (graphic design)
- units
- axis labels
- legible font sizes
...
- scales
- interactive? (if published to web resource)
=======================================
...
=======================================
- climate change / pollution / measures of sustainability 
- population data, choices, trajectories
- assessments of survival rates
- rates of disease, life expectancy
- economic data -- CBA 
- policy data
=======================================
...
=======================================
- time series type is most appropriate
- ggplot2 function
- scale_x_data() to customize labels
- plotly or dygraphs makes it interactive
- heat map -- e.g. displaying climate changes
=======================================
...
mutate(EnoDischarge, Discharge.m3s = EnoDischarge./0.0283)
print (EnoPlot2)
```
