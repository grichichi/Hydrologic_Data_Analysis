...
```{r}
EnoPlot <- 
   ggplot(EnoDGH, aes(x = GageHeight, y = Discharge)) +
          geom_line() +
          xlab("GageHeight (ft)") +
...
> ANSWER: As Gage Height increases, so does Discharge. The relationship is positive and slightly exponential. 
...
EnoPlot2 <-
  ...
  geom_violin() +
  #scale_color_viridisLite(discrete=TRUE) +
  #draw_quantiles(0.5) +
  theme_ipsum() +
  ylab("Discharge (ft^3/s)")
print(EnoPlot2)
...
> ANSWER: There is a sharp increase in Discharge in the year 2014. 
